...
class PointerNetwork(nn.Module):
    ...
    #def forward(self, inputs, eval_tours=None, return_pi=False, Measures=False, Plot_Data=False):
        ...
        cost_0, mask, misMatch_0, _, recall_accuracy_0_mean, recall_accuracy_0_max, recall_accuracy_0_min, radius_mean, radius_max = self.problem.get_costs(inputs, pi_0, labels, Measures, Plot_Data)
        cost_1, mask, misMatch_1, _, recall_accuracy_1_mean, recall_accuracy_1_max, recall_accuracy_1_min, radius_mean, radius_max = self.problem.get_costs(inputs, pi_1, labels, Measures, Plot_Data, P=1)
        ...
        if return_pi:
            ...
            return cost_0, cost_1, ll_0, ll_1, pi_0, pi_1, misMatch_0, misMatch_1, None, recall_accuracy_0_mean, recall_accuracy_0_max, recall_accuracy_0_min, recall_accuracy_1_mean, recall_accuracy_1_max, recall_accuracy_1_min, radius_mean, radius_max

        #return cost, ll, misMatch_y, misMatch_x, recall_accuracy, radius_mean, radius_max, recall_accuracy_max, recall_accuracy_min
        return cost_0, cost_1, ll_0, ll_1, misMatch_0, misMatch_1, None, recall_accuracy_0_mean, recall_accuracy_0_max, recall_accuracy_0_min, recall_accuracy_1_mean, recall_accuracy_1_max, recall_accuracy_1_min, radius_mean, radius_max
