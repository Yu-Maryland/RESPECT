...
class PointerNetwork(nn.Module):
    ...
    #def forward(self, inputs, eval_tours=None, return_pi=False, Measures=False, Plot_Data=False):
        ...
        cost_1, mask, misMatch_1, _, recall_accuracy_1_mean, recall_accuracy_1_max, recall_accuracy_1_min, radius_mean, radius_max = self.problem.get_costs(inputs, pi_1, labels, Measures, Plot_Data)
