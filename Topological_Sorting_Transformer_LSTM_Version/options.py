...
def get_options(args=None):
    ...
    # Training
    parser.add_argument('--lr_model', type=float, default=1e-6, help="Set the learning rate for the actor network")
    parser.add_argument('--lr_critic', type=float, default=1e-6, help="Set the learning rate for the critic network")
