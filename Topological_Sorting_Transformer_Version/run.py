...
def run(opts):
    ...
    model = model_class(
        ...
        problem,
        opts.n_head_encoder,
        opts.n_layer_encoder,
        opts.n_head_decoder,
        opts.n_layer_decoder,
        mask_logits=True,
    ...
    lr_scheduler = optim.lr_scheduler.LambdaLR(optimizer, lambda epoch: opts.lr_decay ** (epoch // 30))
    ...
    if opts.eval_only:
        #validate(model, val_dataset, opts, plot=False)
